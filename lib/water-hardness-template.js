...
<html lang="en">
  ...
  <body>
    <main class="page">
      ...
      ${bodyContent}
      <footer>
        MyApartmentWaterQuality.com is an independent lookup tool, not affiliated with any government agency. Hardness data is sourced from public utility records. <a href="/privacy">Privacy Policy</a>
      </footer>
    </main>
...
function renderSystem(system, deployDate) {
  ...
  const bodyContent = `
    ...
    <section>
      ...
      <h2>What ${escapeHtml(system.city)} water means for your hair and skin</h2>
      ${bandMeaning(system)}
    </section>
...
function renderPrivacy() {
  var bodyContent = `
    <header>
      ...
      <p>This policy covers myapartmentwaterquality.com, an independent lookup tool operated by GRN Labs.</p>
    </header>

    <section>
      <h2>What we collect</h2>
      <p>To generate your water report: your zip code and email. When you browse: standard signals such as pages visited and referring site.</p>
    </section>

    <section>
      <h2>How we use it</h2>
      <p>Your zip code looks up your area&#039;s water hardness from public USGS and utility records. Your email is used to deliver your report and for occasional follow-up about your water and related products. Every email includes an unsubscribe link, and unsubscribing stops them.</p>
    </section>

    <section>
      <h2>Who we share with</h2>
      <p>Our email provider, to send your report. We don&#039;t sell your personal information.</p>
    </section>

    <section>
      <h2>Retention</h2>
      <p>Lookup records are kept as long as needed to provide the report and for legal requirements.</p>
    </section>

    <section>
      <h2>Your choices</h2>
      <p>Email <a href="mailto:support@agsoftener.com">support@agsoftener.com</a> to ask what we hold, correct it, or request deletion. California residents can exercise their CCPA rights the same way.</p>
    </section>
    ...
    <section>
      <h2>Contact</h2>
      <p><a href="mailto:support@agsoftener.com">support@agsoftener.com</a></p>
    </section>
  `;

  var html = pageShell({
    title: "Privacy policy",
    metaDesc: "Privacy policy for myapartmentwaterquality.com.",
    headExtra: '<meta name="robots" content="noindex">',
    bodyContent: bodyContent
  });
...
module.exports = { renderIndex, renderSystem, renderNotFound, renderHardestCities, renderMethodology, renderLandlordHardWater, renderWrongNumberProblem, renderPrivacy };
