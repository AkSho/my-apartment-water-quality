...
function renderHardestCities(systems) {
  ...
  var bodyContent = `
    ...
    <section>
      ...
      <p>Where a utility publishes a range, we use the midpoint and show the range on the city&#039;s report page. Where a utility publishes grains per gallon, we convert at 17.1 ppm per grain. When we re-check a figure, the city&#039;s page shows the verification date.</p>
...
module.exports = { renderIndex, renderSystem, renderNotFound, renderHardestCities };
